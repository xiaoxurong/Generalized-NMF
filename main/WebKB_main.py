...
def main(model, r, n, K, sigma=0.0, alpha=0.1, l1_reg=0.01, random_state=None, max_iter=50, tol=1e-6, graph_weighting='dot-product', n_nonzero_coefs=8):
    ...
    if model == 'sscnmf':
        ...
        project_name = 'ssc-omp-nmf-WEBKB'
